...
IF NOT "%~2"=="" SET origin_audio_bitrate=%~2
...
SET file=%~1
IF "%~2"=="" SET origin_audio_bitrate=134144
SET bv=%target_video_bitrate_kbit_s%
SET output=%~1-25mb-libvpx-vp9
SET args=-strict -2 -c:v libvpx-vp9 -cpu-used 4 -auto-alt-ref 1 -aq-mode 0 -tune-content screen -deadline good -lag-in-frames 25 -row-mt 1 -threads 8 
